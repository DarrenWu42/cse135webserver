...
CREATE TABLE `performance`(
	`sess_id` VARCHAR(32) UNIQUE,
	`start_time`  DECIMAL(10, 3) UNSIGNED,
	`fetch_start`  DECIMAL(10, 3) UNSIGNED,
	`request_start`  DECIMAL(10, 3) UNSIGNED,
	`response_start`  DECIMAL(10, 3) UNSIGNED,
	`response_end`  DECIMAL(10, 3) UNSIGNED,
	`dom_interactive`  DECIMAL(10, 3) UNSIGNED,
	`dom_loaded_start`  DECIMAL(10, 3) UNSIGNED,
	`dom_loaded_end`  DECIMAL(10, 3) UNSIGNED,
	`dom_complete`  DECIMAL(10, 3) UNSIGNED,
	`load_event_start`  DECIMAL(10, 3) UNSIGNED,
	`load_event_end`  DECIMAL(10, 3) UNSIGNED,
